...
xcopy provider\target\cardone-log-provider-*.jar dist\production\provider /Y/C/R/I
...
xcopy consumer\target\cardone-log-consumer-*.jar dist\production\consumer /Y/C/R/I
pause