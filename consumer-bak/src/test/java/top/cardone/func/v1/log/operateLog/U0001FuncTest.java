...
public class U0001FuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/v1/log/operateLog/u0001.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/v1/log/operateLog/U0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/v1/log/operateLog/U0001FuncTest.func.output.json")
