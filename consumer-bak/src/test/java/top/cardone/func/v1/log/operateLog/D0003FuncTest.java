...
public class D0003FuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/v1/log/operateLog/d0003.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/v1/log/operateLog/D0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/v1/log/operateLog/D0003FuncTest.func.output.json")
