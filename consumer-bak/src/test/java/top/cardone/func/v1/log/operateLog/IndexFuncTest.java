...
public class IndexFuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/v1/log/operateLog/index.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/v1/log/operateLog/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/v1/log/operateLog/IndexFuncTest.func.output.json")
