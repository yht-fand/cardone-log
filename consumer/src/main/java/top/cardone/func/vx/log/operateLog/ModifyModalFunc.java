 ...
 */
@Log4j2
@Component("/vx/log/operateLog/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String operateLogId = MapUtils.getString(inputMap, "operateLogId");

        if (StringUtils.isBlank(operateLogId)) {
            throw new CodeException("操作日志标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(OperateLogService.class).findOneByOperateLogId(newInputMap);
