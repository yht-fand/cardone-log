...
public class IndexFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/log/operateLog/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/log/operateLog/IndexFuncTest.func.output.json")
