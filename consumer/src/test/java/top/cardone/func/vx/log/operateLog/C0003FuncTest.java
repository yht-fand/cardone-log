...
public class C0003FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/log/operateLog/C0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/log/operateLog/C0003FuncTest.func.output.json")
