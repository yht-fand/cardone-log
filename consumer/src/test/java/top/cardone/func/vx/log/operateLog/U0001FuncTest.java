...
public class U0001FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/log/operateLog/U0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/log/operateLog/U0001FuncTest.func.output.json")
