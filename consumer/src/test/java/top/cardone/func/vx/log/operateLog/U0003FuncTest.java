...
public class U0003FuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/vx/log/operateLog/u0003.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/log/operateLog/U0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/log/operateLog/U0003FuncTest.func.output.json")
