...
public class U0003FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/log/operateLog/U0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/log/operateLog/U0003FuncTest.func.output.json")
