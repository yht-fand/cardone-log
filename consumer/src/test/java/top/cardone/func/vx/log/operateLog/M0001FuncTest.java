...
public class M0001FuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/vx/log/operateLog/m0001.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/vx/log/operateLog/M0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/vx/log/operateLog/M0001FuncTest.func.output.json")
