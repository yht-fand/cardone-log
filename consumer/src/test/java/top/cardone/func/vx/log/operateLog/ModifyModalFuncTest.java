...
public class ModifyModalFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/log/operateLog/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/log/operateLog/ModifyModalFuncTest.func.output.json")
