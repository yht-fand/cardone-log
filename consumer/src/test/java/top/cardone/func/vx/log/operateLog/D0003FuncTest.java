...
public class D0003FuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/vx/log/operateLog/d0003.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/vx/log/operateLog/D0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/vx/log/operateLog/D0003FuncTest.func.output.json")
